...
export const PLAYER_ID_STR        : string = "1";
export const OPPONENT_ID          : number = 2;
export const OPPONENT_ID_STR      : string = "2";
export const PUBLIC_USER_ID       : string = "64fa4dec-0cff-461c-aae9-497619d28218";