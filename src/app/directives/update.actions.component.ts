...
export class UpdateActionsComponent  {
  ...
  @Input() fSLabel      : string = 'Save';  // text to put in the label of an Add button if labels in use
  @Input() fRLabel      : string = 'Remove';// text to put in the label of an Add button if labels in use
