...
export class TournamentListComponent implements OnInit {
  ...
  submitRequest(form : NgForm) : void {
    ...
    this.dataSvc.updateList(TOURNAMENT_TABLE_NAME, this.itemName, action, parseInt(this.selectedItem))   // send the update
    .then((success) => {
      this.utilSvc.setUserMessage(msgId, msg);
      this.utilSvc.displayUserMessages();
      this.resetForm(form);
      this.dataSvc.getList(TOURNAMENT_TABLE_NAME)  // re-read the list
      .then((list) => {
