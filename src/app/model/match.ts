...
import { PLAYER_ID, OPPONENT_ID } from '../constants'
    ...
    export class Match {
      ...
      static MATCH_FORMATS =                  ["2 out of 3 sets","2 sets + Tiebreak",
                                              "1 set (6 games)", "1 set (8 games)", "10-Pt Tiebreak"];
      static TWO_OF_THREE_MATCH_FORMAT =      0;
      static TWO_PLUS_TIEBREAK_MATCH_FORMAT = 1;
      static ONE_SIX_SET_MATCH_FORMAT =       2;
      static ONE_EIGHT_SET_MATCH_FORMAT =     3;
      static ONE_TIEBREAK_MATCH_FORMAT =      4;
      static DEFAULT_MATCH_FORMAT =           1;
      ...
      addNewSet() : void {
        ...
        switch(this.format){ //first, decide what type of set to add
          case Match.ONE_EIGHT_SET_MATCH_FORMAT:
            setLog.t = TSet.EIGHT_GAME_SET_TYPE;
            break;
          case Match.ONE_SIX_SET_MATCH_FORMAT:
          case Match.TWO_OF_THREE_MATCH_FORMAT:
            setLog.t = TSet.SIX_GAME_SET_TYPE;
            break;
          case Match.TWO_PLUS_TIEBREAK_MATCH_FORMAT:
            if(setsLen < 2){
              setLog.t = TSet.SIX_GAME_SET_TYPE;
            } else{
              setLog.t = TSet.TIEBREAK_SET_TYPE;
            }
            break;
          case Match.ONE_TIEBREAK_MATCH_FORMAT:
            setLog.t = TSet.TIEBREAK_SET_TYPE;
            break;
          default:
        }
